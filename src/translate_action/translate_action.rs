...
/// Translated Action sizes and percentages to use each one.
///
/// * Percentages should always sum to 1.0.
/// * When returning for only one size, smaller_size and larger_size should be set to the same
///   value, and smaller_percentage should bet set to 1.0 and larger_size should bet set to 0.0.
#[allow(dead_code)]
#[derive(Debug)]
