...
///
/// Wraps an [`ObservationIterator`] and filters to only yield observations
/// that are already in canonical form. This avoids generating duplicates
/// when building the abstraction hierarchy.
