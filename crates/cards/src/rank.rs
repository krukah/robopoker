...
///
/// Ranks are encoded as `0..13` and ordered naturally for hand comparison.
/// Multiple numeric representations support different evaluation algorithms:
///
...
impl Rank {
    /// Bitmask covering the 13 rank bits in a u16.
    const fn mask() -> u16 {
        0b1111111111111
    }
