...
mod tests {
    ...
    #[test]
    fn injective_u64() {
        assert_eq!(u64::from(Suit::C), 0b0001000100010001000100010001000100010001000100010001);
        assert_eq!(u64::from(Suit::D), 0b0010001000100010001000100010001000100010001000100010);
        assert_eq!(u64::from(Suit::H), 0b0100010001000100010001000100010001000100010001000100);
        assert_eq!(u64::from(Suit::S), 0b1000100010001000100010001000100010001000100010001000);
    }
}
