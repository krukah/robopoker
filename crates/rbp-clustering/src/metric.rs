...
impl rbp_pg::Schema for Metric {
    ...
    fn truncates() -> &'static str {
        const_format::concatcp!("TRUNCATE TABLE ", rbp_pg::METRIC, ";")
    }
...
impl rbp_pg::Streamable for Metric {
    type Row = (i32, f32);
...
impl Metric {
    pub async fn from_street(client: &tokio_postgres::Client, street: Street) -> Self {
        let sql = const_format::concatcp!("SELECT tri, dx FROM ", rbp_pg::METRIC);
